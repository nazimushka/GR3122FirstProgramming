...
// Чтение данных из консоли. КОПИЯ С ПРЕДЫДУЩИХ ЗАДАЧ
...
// Печать результата   КОПИЯ С ПРЕДЫДУЩИХ ЗАДАЧ
void PrintResult(string line)
{
    Console.WriteLine(line);
}

// Заполняем массив   КОПИЯ С ПРЕДЫДУЩИХ ЗАДАЧ
...
// печатаем массив  КОПИЯ С ПРЕДЫДУЩИХ ЗАДАЧ
